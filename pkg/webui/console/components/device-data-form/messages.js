...
export default defineMessages({
  ...
  asServerIDDescription:
    'The KEK label of the Application Server to use for wrapping the application session key',
  asServerIDPlaceholder: 'as server id',
  asServerKekLabel: 'Application Server Kek Label',
  asServerKekLabelDescription: 'The AS-ID of the Application Server to use',
  asServerKekLabelPlaceholder: 'as server kek label',
  ...
  multicast: 'Multicast',
  netID: 'Net ID',
  netIDDescription: 'Home NetID',
  nsNotInCluster: 'NS is not in this cluster',
  nsServerKekLabel: 'Network Server Kek Label',
  nsServerKekLabelDescription: 'The NS-ID of the Network Server to use',
  nsServerKekLabelPlaceholder: 'ns server kek label',
